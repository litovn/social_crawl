...
def main():
    ...
    if args.headless:
        if args.root:
            twitter_getter = Posts(args.username, args.password, args.email_address, args.wait_scroll_base,
                              args.wait_scroll_epsilon, args.num_scrolls, args.mode, args.since_id, args.max_id,
                              args.since, args.until, args.since_time, args.until_time, headless=True, root=True)
        else:
            twitter_getter = Posts(args.username, args.password, args.email_address, args.wait_scroll_base,
                              args.wait_scroll_epsilon, args.num_scrolls, args.mode, args.since_id, args.max_id,
                              args.since, args.until, args.since_time, args.until_time, headless=True)
    else:
        if args.root:
            twitter_getter = Posts(args.username, args.password, args.email_address, args.chromedriver,
                                   args.wait_scroll_base, args.wait_scroll_epsilon, args.num_scrolls, args.mode,
                                   args.since_id, args.max_id, args.since, args.until, args.since_time, args.until_time, root=True)
        else:
            twitter_getter = Posts(args.username, args.password, args.email_address, args.chromedriver,
                                   args.wait_scroll_base, args.wait_scroll_epsilon, args.num_scrolls, args.mode,
                                   args.since_id, args.max_id, args.since, args.until, args.since_time, args.until_time)
    ...
    twitter_getter.set_query(args.query)
